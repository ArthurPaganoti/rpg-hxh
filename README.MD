...
- `maxPlayers` — Opcional, entre 2 e 20 (padrão 10)
...
Atualiza o nome da sala. **Apenas o Mestre** pode atualizar (403 para outros usuários). O nome segue as mesmas validações da criação (3 a 100 caracteres).
